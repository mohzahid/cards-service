...
class CardRecordsControllerTest {
    ...
    @Test
    public void testCreateValidCardEnrolment_SuccessResponse() throws Exception {
    ...
    @Test
    public void testCreateInValidCardEnrolment_FailedResponse() throws Exception {
    ...
    @Test
    public void testGetAllCardDetails_SuccessResponse() throws Exception {
    ...
    @Test
    public void testGetAllCardDetails_FailedResponse() throws Exception {
